1️⃣ JwtTokenProvider.java

📁 com/example/demo/security/JwtTokenProvider.java
...
✔ Tests check username=email
✔ Throws UsernameNotFoundException correctly
...
✔ Stateless and test-safe

4️⃣ SecurityConfig.java

📁 com/example/demo/security/SecurityConfig.java
